...
const schema = yup.object().shape({
  ...
  password: yup
    ...
    .test(
      'is-empty-or-valid',
      'Mật khẩu phải có ít nhất 6 ký tự và chứa ít nhất 1 chữ hoa, 1 chữ thường và 1 số',
      value => !value || VALID_PASSWORD_REGEX.test(value)
    )
    .nullable(),
  name: yup
    .string()
...
const SidebarAddAdmin = props => {
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h5'>Thêm quản trị viên</Typography>
        <IconButton
          size='small'
          onClick={handleClose}
          sx={{
